        ...
        <div className="flex flex-wrap flex-col py-32 px-10">
            <div className="flex flex-col  justify-center items-center gap-5">
                ...
                <div className="text-center">
                    <p>Delicious Meals, Delivered to Your Train compartment.</p> 
                    <p>No more worrying for bad food. Get your favorite meals delivered in no time, hassle-free.</p>
                </div>
            </div>
            <div className="py-32 flex flex-wrap justify-evenly">
                ...
                <div className="flex flex-col p-5">
                    ...
                    <div className="">
                        <h4 className="text-xl font-semibold">Super fast delivery in your compartment</h4>

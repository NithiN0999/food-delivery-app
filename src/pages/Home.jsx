        ...
        <div className="flex flex-col md:mt-32 lg:mt-52 px-5 ml-5">
          <div className="flex flex-col justify-center items-center">
            <h3 className="text-3xl font-semibold">
              Why <b className="text-red-600">Train Bites</b>?
            </h3>
            <p className="text-sm">
              <span className="text-red-500">Train Bites</span> is a revolutionary
              food delivery app designed to make your train experience more
